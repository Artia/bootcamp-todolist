...
RSpec.describe ProjectsController, type: :controller do
  ...
  let(:project) { Project.create(title: 'Testando project controller')}
  ...
  describe 'POST#create' do
    context 'sucesso' do
      before do
        @params = {"project"=>{"title"=>"Meu quarto projeto"}, "commit"=>"Save"}
      end
  ...
  describe 'PATCH#update' do
    context 'sucesso' do
      before do
        @params = {"project"=>{"title"=>"Teste update"}, "commit"=>"Save", "id"=>project.id}
        patch :update, params: @params
      end

      it 'deve atualizar o título do projeto' do
        expect(project.reload).to have_attributes(title: "Teste update")
      end
    ...
    context 'erro' do
      ...
      it 'não deve atualizar o título do projeto' do
        ...
        expect(project.reload.title).to eq('Testando project controller')
      end
